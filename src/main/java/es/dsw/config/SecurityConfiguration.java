	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			.authorizeHttpRequests((authorize) -> authorize
									...
									.requestMatchers("/publicar2_1").permitAll()
									.requestMatchers("/paso2_1").permitAll()
									.requestMatchers("/publicar2_2").permitAll()
									.requestMatchers("/paso2_2").permitAll()
									...
									.requestMatchers("/borrarComentarios").permitAll()
